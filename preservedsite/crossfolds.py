...
def generate(data, category, values, crossfolds, target_column, patient_column , site_column, timelimit, randomseed, output_csv):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--crossfolds', type=int, help='number of crossfolds to split data into', default=3)
    ...
    generate(pd.read_csv(args.data_csv), args.category, args.values, args.crossfolds, args.target_column, args.patient_column, args.site_column, args.timelimit, args.randomseed, args.output_csv)