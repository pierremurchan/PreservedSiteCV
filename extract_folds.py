...
def genrate_pt(input_csv, cv_col, output_file):
    ...
    torch.save(patient_indices_tuple, output_file)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--output-file', type=str, help='Output file name', default='folds.pt')

    args = parser.parse_args()

    genrate_pt(args.input_csv, args.cv_col, args.output_file)
